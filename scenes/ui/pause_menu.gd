...
@onready var start_button : Button = $MenuContainer/PauseMenu/VBoxContainer/VBoxContainer/Resume
@onready var options_button : Button = $MenuContainer/PauseMenu/VBoxContainer/VBoxContainer/Options
@onready var exit_button : Button = $MenuContainer/PauseMenu/VBoxContainer/VBoxContainer/Quit

#@onready var on_resume_sound : AudioStream = load("res://Assets/Audio/SFX/magic_ring_sfx.mp3")

@onready var main_menu : Control = $MenuContainer/PauseMenu
...
@onready var ui : Control = $MenuContainer
